...
--method random-dfs -seed 4 -to 0[23467] -step 500 -sp r:tf --st-name 9 -nst \
...
--method random-dfs -to "[01]=asw(1)[23456789]=asw(1)" -step 500 -sp r:tf --st-name 12 -nst \
...
--method random-dfs -to 012347 -dto "16,0[12347]=asw(1,0,0,0,0,0)" -step 500 -sp r:tf --st-name 24 -nst \
--method random-dfs -to 01234567 -dto "13,[0187465]=asw(1)" -dto "26,[0134587]=asw(1)" -step 500 -sp r:tf --st-name 32 -nst \
--method random-dfs -to "0123" -dto2 "6,01[2435]=asw(3,20,10,0,1)" -dto2 "13,[01234567]=asw(1)" -step 500 -sp r:tf --st-name new -nst \
...
--method random-dfs -to "[01][23457]" -dto2 "5,[0123][4567]" -dto2 "13,[01234567]=asw(1)" -seed 33627 -step 500 -sp r:tf --st-name sG -nst \
--method random-dfs -to "[01][23457]" -dto2 "5,[0123][4567]" -dto2 "13,[01234567]=asw(1)" -seed 18296 -step 500 -sp r:tf --st-name sH -nst \
--method random-dfs -to "01[2357]" -dto2 "9,[012][4678]" -dto2 "15,[01234678]=asw(1)" -seed 10468 -step 500 -sp r:tf --st-name sI \
--prelude "295@24,330@5,380@9,414@sI,600@sF,490@sH,428@sG,760@32,380@12,380@24,380@10,380@5,200@s1,200@new,222@sE,225@sD,266@sB,380@3,380@9,380@24,380@18,760@20,380@11,760@24,380@11"
