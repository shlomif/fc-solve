#!/bin/sh
# This scan is derived from ct-mod9.sh in scripts/TEST_OPTIMIZATIONS by
...
--method random-dfs -to "[01][23457]" -dto2 "5,[0123][4567]" -seed 18296 -step 500 -sp r:tf --st-name sH \
--prelude "380@24,380@5,380@9,366@sF,490@sH,428@sG,760@32,380@12,380@24,380@10,380@5,200@s1,200@new,222@sE,225@sD,138@sA,266@sB,174@sC,380@3,380@9,380@24,380@18,760@20,380@11,760@24,380@9,380@11,380@9,380@10,380@15,760@15,380@18,380@15,380@18,380@20,380@22,380@24,380@32,760@18,1520@32,1520@24,2280@10,2280@24"
