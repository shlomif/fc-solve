...
--method random-dfs -to 01234j -dto "16,0[1234j]=asw(1,0,0,0,0,0)" -step 500 -sp r:tf --st-name 24 -nst \
--method random-dfs -to 0123456j -dto "13,[018j465]=asw(1)" -dto "26,[013458j]=asw(1)" -step 500 -sp r:tf --st-name 32 -nst \
...
--prelude "295@24,230@5,280@9,414@sI,600@sF,490@sH,428@sG,760@32,380@12,380@24,380@10,380@5,200@s1,200@new,222@sE,225@sD,266@sB,380@3,380@9,380@24,380@18,760@20,380@11,760@24,380@11"
