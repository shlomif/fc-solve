# This scan is based on as-modified-13.sh only it contains the new scans:
#   --st-name sE - for solving some of the lowest hanging fruit generated
#       by find-min-seed-for-as-13-scans--parallel.pl
#
...
--method random-dfs -to "01[234567]" -dto2 "6,0132[456789]" -seed 6519 -step 500 -sp r:tf --st-name s5 -nst \
--method random-dfs -to "01[234579]" -seed 958 -step 500 -sp r:tf --st-name s6 -nst \
--method random-dfs -to "01[234579]" -seed 1120 -step 500 -sp r:tf --st-name s7 -nst \
--method random-dfs -to "[01][23457]" -dto2 "7,[0123][4567]" -seed 37947 -step 500 -sp r:tf --st-name s8 -nst \
...
--method random-dfs -to "[01][23457]" -dto2 "7,[0123][4567]" -seed 115235 -step 500 -sp r:tf --st-name sE \
--prelude "380@24,380@5,380@9,760@32,380@12,380@24,380@10,380@5,200@s1,120@s2,200@new,222@sE,225@sD,138@sA,266@sB,174@sC,106@s7,70@s8,95@s9,380@3,380@9,380@24,380@18,85@s5,87@s6,760@20,100@s3,171@s4,380@11,380@12,380@5,760@24,380@21,380@4,380@9,380@11,380@9,380@10,380@4,380@5,380@15,380@5,760@15,380@18,380@21,380@15,380@18,380@20,380@22,760@23,380@24,380@32,1520@12,760@18,1520@32,1520@24,2280@10,2280@24,4560@12"
