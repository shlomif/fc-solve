...
--method random-dfs -to "[01][23457]" -dto2 "10,[0123][4567]" -seed 10468 -step 500 -sp r:tf --st-name sI -nst \
--method random-dfs -to "[01][23457]" -dto2 "5,[0123][4567]" -seed 5974 -step 500 -sp r:tf --st-name sJ \
--prelude "380@24,380@5,380@9,510@sJ,414@sI,366@sF,490@sH,428@sG,760@32,380@12,380@24,380@10,380@5,200@s1,200@new,222@sE,225@sD,266@sB,380@3,380@9,380@24,380@18,760@20,380@11,760@24,380@11"
