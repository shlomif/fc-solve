# This scan is based on as-modified-2.sh only it contains the new scans:
#   --st-name s2 - for solving 14249 - generated using find-min-seed-for-14249.pl.
#   --st-name s3 - for solving 10692 - generated using find-min-seed-for-10692.pl
#   --st-name s4 - for solving 31465 - generated using find-min-seed-for-31465.pl
#
