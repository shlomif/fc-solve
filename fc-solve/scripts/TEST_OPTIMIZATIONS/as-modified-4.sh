# This scan is based on as-modified-4.sh only it contains the new scans:
#   --st-name s5 - for solving 3294 - generated using find-min-seed-for-3294.pl
#   --st-name s6 - for solving 1941 - generated using find-min-seed-for-1941.pl
#
...
--method random-dfs -to "01[234568]" -dto2 "6,0132[456789]" -seed 6519 -step 500 -sp r:tf --st-name s5 -nst \
--method random-dfs -to "01[234567]" -dto2 "6,0132[456789]" -seed 3894 -step 500 -sp r:tf --st-name s6 \
--prelude "380@24,380@5,380@9,760@32,380@12,380@24,380@10,380@5,200@s1,120@s2,200@new,100@s5,1128@s6,380@3,380@9,380@24,380@18,760@20,100@s3,171@s4,380@11,380@12,380@5,760@24,380@21,380@4,380@9,380@11,380@9,380@10,380@4,380@5,380@15,380@5,760@15,380@18,380@21,380@15,380@18,380@20,380@22,760@23,380@24,380@32,1520@12,760@18,1520@32,1520@24,2280@10,2280@24,4560@12"
