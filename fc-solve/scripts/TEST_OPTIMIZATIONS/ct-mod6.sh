#!/bin/sh
# This scan is derived from ct.sh in scripts/TEST_OPTIMIZATIONS by first
# promoting the "sF" scan in the prelude and then adding a new scan "sG".
...
--method random-dfs -to "[01][23457]" -dto2 "5,[0123][4567]"  -seed 33627 -step 500 -sp r:tf --st-name sG \
--prelude "380@24,380@5,380@9,366@sF,428@sG,760@32,380@12,380@24,380@10,380@5,200@s1,120@s2,200@new,222@sE,225@sD,138@sA,266@sB,174@sC,95@s9,380@3,380@9,380@24,380@18,760@20,380@11,380@12,380@5,760@24,380@21,380@4,380@9,380@11,380@9,380@10,380@4,380@5,380@15,380@5,760@15,380@18,380@21,380@15,380@18,380@20,380@22,380@24,380@32,1520@12,760@18,1520@32,1520@24,2280@10,2280@24,4560@12"
