...
(
    ...
    clang -shared -fPIC -O3 -march=native -flto -o lib"opencl_find_deal_idx.so" -I ~/Download/unpack/to-del/www.dmi.unict.it/bilotta/gpgpu/svolti/aa201920/opencl/ -Wall -Wextra "../../source/board_gen/opencl_find_deal_idx.c" -lOpenCL && \
       (
