...
cd build
cmake -DFCS_WITH_TEST_SUITE= -DCMAKE_INSTALL_PREFIX="$HOME/apps/fcs" ..
make boards
...
OBJS="../app_str.c ../scans.c ../test_multi_parallel.c ../lib.c ../preset.c ../instance.c ../move_funcs_order.c  ../move_funcs_maps.c ../meta_alloc.c ../cmd_line.c ../card.c ../state.c ../check_and_add_state.c ../fcs_hash.c ../split_cmd_line.c ../simpsim.c ../freecell.c ../move.c ../fc_pro_iface.c ../rate_state.c"

# emcc -m32 -std=gnu99 -g -o fc-solve.js -I. $OBJS --embed-file 24.board
emcc -s TOTAL_MEMORY=$((128 * 1024 * 1024)) -O2 -m32 -std=gnu99 -o range-fc-solve.js -I. $OBJS --embed-file 24.board
