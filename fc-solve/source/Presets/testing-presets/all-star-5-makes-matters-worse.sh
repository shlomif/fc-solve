...
--method random-dfs -to "[01][23456789]=asw(1)" -seed 8 -step 500 -sp r:tf --st-name 10 -nst \
...
--method random-dfs -to 01234567 -dto "13,[0187465]=asw(1)" -dto "26,[0134587]=asw(1)" -step 500 -sp r:tf --st-name 32 \
