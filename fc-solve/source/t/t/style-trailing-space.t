...
(?:\.(?:a|dll|exe|o|patch|pyc|xcf)\z) |
(?:(?:\A|/|\\)valgrind\S*\.log\z) |
(?:(?:\A|/|\\)(?:dbm_fc_solver|depth_dbm_fc_solver|fc-solve|fc-solve-pruner|freecell-solver-fc-pro-range-solve|freecell-solver-fork-solve|freecell-solver-multi-thread-solve|freecell-solver-range-parallel-solve|libfcs_dbm_calc_derived_test\.so|libfcs_debondt_delta_states_test\.so|libfcs_delta_states_test\.so|libfcs_fcc_brfs_test\.so|libfreecell-solver\.so(?:[\.0-9]*)|measure-depth-dep-tests-order-perf|pi-make-microsoft-freecell-board|split_fcc_fc_solver|summary-fc-solve)\z)
#msx,
        }
    );
