...
USAGE to learn more about it. If you are looking for a nice graphical
user-interface using the Freecell Solver engine for Windows, you should wait for 
the upcoming version 6.5 of Freecell Pro.
